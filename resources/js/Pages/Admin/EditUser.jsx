...
export default function EditUser({editedUser}) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        password_confirmation: editedUser.password || '',
    });
    ...
    const submit = (e) => {
        ...
        put(route('users.update',editedUser.id));
    };
    ...
    return (
        <div  className={`${isDarkMode ? 'bg-slate-800 text-white h-screen pt-12' : ''} `}>
            ...
            <div class={`${isDarkMode ? 'border border-gray-500' : ''}  max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden mt-20`}>
                <h2 class="text-2xl mb-8 font-medium mb-1">Edit User {editedUser.id}</h2>
