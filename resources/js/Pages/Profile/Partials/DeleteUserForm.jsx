...
export default function DeleteUserForm({ className = '' }) {
    ...
    return (
        <section className={`space-y-6 ${className}`}>
            <header>
                <h2 className={`${isDarkMode ? 'text-white ' : ' text-gray-900'}text-lg font-medium `}>Delete Account</h2>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal} className={`${isDarkMode ? 'text-white bg-slate-800' : ' text-gray-900'}`}>
